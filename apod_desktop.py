...
script_dir = r"D:\Semester 2\Scripting Applications\Final_Project"
...
def get_apod_date():
    ...
    if num_params >= 1:
        ...
        MIN_APOD_DATE = datetime.date(1995, 6, 16)
